    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_job_categories", x => x.category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_job_category_link", x => new { x.job_id, x.category_id });
                    table.ForeignKey(
                        name: "FK_job_category_link_job_categories_category_id",
                        column: x => x.category_id,
                        principalTable: "job_categories",
                        principalColumn: "category_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_job_category_link_jobs_job_id",
                        column: x => x.job_id,
                        principalTable: "jobs",
                        principalColumn: "job_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_job_category_link_category_id",
                table: "job_category_link",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "IX_jobs_posted_by",
                table: "jobs",
                column: "posted_by");
        }
